...
urlpatterns = [
    ...
    path('api/leagues/<str:api_id>/', api_views.get_league_detail, name='api_league_detail'),
    path('api/leagues/<str:api_id>/standings/', api_views.get_league_standings, name='api_league_standings'),
    ...
    path('api/teams/<int:api_id>/standings/', api_views.get_team_standings, name='api_team_standings'),
    path('api/teams/<int:api_id>/matches/', api_views.get_team_matches, name='api_team_matches'),

    # Players
    path('api/players/', api_views.get_players, name='api_players'),
    path('api/players/<int:api_id>/', api_views.get_player_detail, name='api_player_detail'),

    # Live matches
    path('api/live-matches/', api_views.get_live_matches, name='api_live_matches'),
    path('api/live-matches/<int:match_id>/', api_views.get_live_match_detail, name='api_live_match_detail'),
    path('api/live-matches/<int:match_id>/events/', api_views.get_match_events, name='api_match_events'),
    path('api/live-matches/<int:match_id>/lineups/', api_views.get_match_lineups, name='api_match_lineups'),

    # Upcoming matches
    path('api/upcoming-matches/', api_views.get_upcoming_matches, name='api_upcoming_matches'),
