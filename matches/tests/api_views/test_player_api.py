...
def setup_players():
    ...
    Player.objects.create(
        api_id=10, name="Lionel Messi", team=team_barca, date_of_birth="1987-06-24"
    )
    Player.objects.create(
        api_id=20, name="Pedri", team=team_barca, date_of_birth="2002-11-25"
    )
    Player.objects.create(
        api_id=30, name="Vinicius Jr", team=team_real, date_of_birth="2000-07-12"
    )
